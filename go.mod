...
require (
	github.com/apigee/apigee-remote-service-envoy/v2 v2.0.0-rc.1.0.20210324213204-b80dc337034f
	github.com/apigee/apigee-remote-service-golib/v2 v2.0.0-20210324210730-9e03f80816b7
